...
--
-- Name: elements foreign_atomic; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: properties foreign_type; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT foreign_type FOREIGN KEY (type_id) REFERENCES public.types(type_id);
